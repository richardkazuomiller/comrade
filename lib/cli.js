  ...
  if(this.actions.indexOf(action) == -1){
    ...
    switch(action){
      case "list":
        ...
        var options = self.getServersOptions(answer)
        ...
        break;
      case "killOldestServer":  
        var options = self.getServersOptions(answer)
        self.client.killOldestServer(options,function(err){
          err && console.log(err.message)
          self.getAction()
        })
        break;
      case "clearStaleServers":  
        self.client.clearStaleServers(function(){
          self.getAction()
        })
        break;
      case "kill":  
      ...
      case "zombify":  
        var id = command.args[0]
        self.client.zombifyServer(id,function(){
          self.getAction()
        })
        break;
    }
...
CLI.prototype.getServersOptions = function(answer){
